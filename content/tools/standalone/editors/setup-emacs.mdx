...
```
For properly identing the whole file hit `C-x h`, this will select whole file and then hit `TAB`.
...
## Customizing Emacs Themes

Emacs provide variety of built-in themes. User can see and enable the theme which suites them the most.
