...
- `features` - translated C++ feature docs that reflect the `/content/features/` folder
...
:::caution
There are also other folders, like `docusaurus-plugin-content-docs-features` but you should ignore them.
