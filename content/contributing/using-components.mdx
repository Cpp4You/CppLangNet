...
import ProductCard 				from "@cpp-lang/comps/ProductCard";

import Image					from "@cpp-lang/comps/Image"; 
import ClassSummaryImg			from "@site/static/img/component-overview/class-summary.png" 
...
<Image center border alt="Class Summary" img={ClassSummaryImg} />
