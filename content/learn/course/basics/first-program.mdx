...
`iostream` is a **header file**. We will use more of them in the near future.
...
Strictly speaking, `cout` is a so-called character output stream, but you don't need to remember that for the moment.
...
In many other online tutorials and sources, it is extremely common to find others recommending `using namespace std;` at the top of your file.
