...
- How to [combine multiple conditions](#compound-conditional-statements) into a mutually exclusive group
- How to [nest if statements](#nesting-conditional-statements) inside of each other
- How to reduce reptition by applying the [DRY Principle](#using-variables-to-reduce-repetition)
