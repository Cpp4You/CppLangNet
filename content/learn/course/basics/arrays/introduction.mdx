...
Let's assume that we want to store the nicknames of players who are on a server.
...
There are a lot of things you can do with an array. In the following lessons we'll go through the most common operations
