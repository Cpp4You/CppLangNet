...
then tokenizes the result (as in [translation phase 3](/docs/std/lang-support/translation_phases#phase-3)), and then uses the result as if the input to <span class='col-d'>#pragma</span> in (1).
