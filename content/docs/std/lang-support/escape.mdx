...
<SymbolTable noTraits>
    ...
    <Symbol name={<i class='col-g'>n-char</i>} desc={<>a character from the <a href="/docs/std/lang-support/charset#translation-character-set">translation character set</a>, except the right curly bracket <code>}</code> or new-line character</>}/>
</SymbolTable>
