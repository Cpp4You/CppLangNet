...
hide_title:				true
tags:					[access, array, reverse, begin, method]
---
...
int main()
{
    ...
    auto it = arr.rbegin(); // Type: std::array<int>::reverse_iterator
    // highlight-next-line
    *it = 5; // ✔ Ok
}
```
...
{
    std::array<int> arr = {1, 2, 3, 4, 5};
    auto it = arr.crbegin(); // Type: std::array<int>::reverse_const_iterator
    // highlight-next-line
    *it = 5; // ❌ Error! 
}
```
...
int main()
{
    const std::array<int> arr = {1, 2, 3, 4, 5};
    auto it = arr.rbegin(); // Type: std::array<int>::reverse_const_iterator
    // highlight-next-line
    *it = 5; // ❌ Error! 
}
```
