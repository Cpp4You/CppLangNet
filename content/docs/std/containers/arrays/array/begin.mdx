...
hide_title:				true
tags:					[access, array, iterator, begin, front, method]
---
...
int main()
{
    ...
    auto it = arr.begin(); // Type: std::array<int>::iterator
    // highlight-next-line
    *it = 5; // ✔ Ok
}
```
...
{
    std::array<int> arr = {1, 2, 3, 4, 5};
    auto it = arr.cbegin(); // Type: std::array<int>::const_iterator
    // highlight-next-line
    *it = 5; // ❌ Error! 
}
```
...
int main()
{
    ...
    auto it = arr.begin(); // Type: std::array<int>::const_iterator
    // highlight-next-line
    *it = 5; // ❌ Error! 
}
```
