...
hide_title:				true
tags:					[access, array, iterator, end, back, method]
---
...
int main()
{
    ...
    auto it = arr.end(); // Type: std::array<int>::iterator
    // highlight-next-line
    *std::prev(it) = 5; // ✔ Ok
}
```
...
{
    std::array<int> arr = {1, 2, 3, 4, 5};
    auto it = arr.cend(); // Type: std::array<int>::const_iterator
    // highlight-next-line
    *std::prev(it) = 5; // ❌ Error! 
}
```
...
int main()
{
    ...
    auto it = arr.end(); // Type: std::array<int>::const_iterator
    // highlight-next-line
    *std::prev(it) = 5; // ❌ Error! 
}
```
