...
import ClassSummary				from "@cpp-lang/comps/ClassSummary";
...
<!-- Top Examples -->
import TopExampleUseCpp20		from "./_codes/vector/main-page/top-example-use-cpp20.mdx";
import TopExampleUseCpp17		from "./_codes/vector/main-page/top-example-use-cpp17.mdx";
import TopExampleUseUntilCpp17	from "./_codes/vector/main-page/top-example-use-until-cpp17.mdx";

<!-- Images -->
import MemoryImg				from "@site/static/img/component-overview/array-elements-in-memory.png"
...
**Note:** 1) is only available since C++17
...
int main() {
	...
	std::vector floats{1.f, 2.f, 3.f, 4.f};

	// 2) Normal:
	std::vector<int>	ints2{1, 2, 3, 4};
	std::vector<float>	floats2{1, 2, 3, 4};
}
```

</div>
</TabItem>
<TabItem value="basics" label="Add, remove, print">
<div style={{ padding: "10px 20px", border: "1px solid gray" }}>

<SwitchView content={
		{
			"cpp20": <TopExampleUseCpp20 />,
			"cpp17": <TopExampleUseCpp17 />,
			"until-cpp17": <TopExampleUseUntilCpp17 />,
		}
	} />
...
<Image center border maxheight="250px" alt="Array elements in memory" img={MemoryImg} />
