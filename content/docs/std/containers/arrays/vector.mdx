...
tags:				[vector, container, dynamic, array, compile-time]
hide_title:			true
---
...
<p align="center">
	<img style={{border: "1px solid gray", maxHeight: 250}} alt="Array elements in memory" src="/img/doc/array-elements-in-memory.png" />
</p>
