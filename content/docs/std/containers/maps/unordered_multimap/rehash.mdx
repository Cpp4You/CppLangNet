...
`rehash(0)` may be used to force an unconditional rehash, such as after suspension of automatic rehashing by temporarily increasing [`max_load_factor()`](/docs/std/containers/maps/unordered_multimap/max_load_factor).
