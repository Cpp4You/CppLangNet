...
If there are no such elements, past-the-end (see [`end()`](/docs/std/containers/maps/unordered_multimap/end)) iterators are returned as both elements of the pair.
