---
title:					unordered_multimap<...>::end() method
sidebar_label:			end( )
...
If the unordered_multimap is empty, the returned iterator will be equal to [`begin()`](/docs/std/containers/maps/unordered_multimap/begin).
