...
This specification was defective and was fixed by [`LWG issue 2469`](https://cplusplus.github.io/LWG/issue2469), and the description above incorporates the resolution of that issue.
