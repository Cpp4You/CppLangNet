---
title:					unordered_map<...>::equal_range() method
...
If there are no such elements, past-the-end (see [`end()`](/docs/std/containers/maps/unordered-map/end)) iterators are returned as both elements of the pair.
