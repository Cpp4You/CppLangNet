...
<!-- Further Examples -->
import FurtherExampleCreateInsertChangePrint from "./_codes/map/main-page/examples/further/create-insert-change-print.mdx"

<!-- Overview -->
import OverviewSimplifiedRegular from "./_codes/map/main-page/overview/overview-simplified-regular.mdx";
import OverviewDetailedRegular from "./_codes/map/main-page/overview/overview-detailed-regular.mdx";
import OverviewDetailedPmr from "./_codes/map/main-page/overview/overview-detailed-pmr.mdx";

<!-- Deduction Guides -->
import DeductionGuides from "./_codes/map/main-page/deduction-guides.mdx"
...
<SymbolTable>
	<Symbol pub autoLink linkName="constructor" name="(constructor)">
		Constructs a new <code>std::map</code>.
	</Symbol>
	<Symbol pub autoLink linkName="destructor" name="(destructor)">
		Destructs a <code>std::map</code>.
	</Symbol>
...
<SymbolTable>
	<Symbol pub autoLink linkName="empty" name="empty">
		Returns <code>true</code> if the queue is empty, otherwise <code>false</code>.
	</Symbol>
...
<SymbolTable>
	...
	<Symbol pub autoLink linkName="extract" name={<>extract <small>(since C++17)</small></>}>
		Extracts nodes from the map (can be later inserted somewhere else).
	</Symbol>
...
<SymbolTable>
	<Symbol pub autoLink linkName="count" name="count">
		Returns the number of elements matching a specific key (for map it's always going to be 1 or 0).
	</Symbol>
	<Symbol pub autoLink linkName="find" name="find">
		Returns an element to an element or if not found, returns `map.end()`.
	</Symbol>
	<Symbol pub autoLink linkName="contains" name={<>contains <small>(since C++20)</small></>}>
		Returns <code>true</code> if an element is inside the map, otherwise <code>false</code>.
	</Symbol>
	<Symbol pub autoLink linkName="equal_range" name="equal_range">
		Returns a range of elements matching a specific key (for map it's always going to be one or zero elements).
	</Symbol>
...
<SymbolTable noTraits>
	...
	<Symbol name={<>std::swap <small>(std::map)</small></>}
		...
		/>
	<Symbol name={<>
				erase <small>(std::map)</small><br/>
				erase_if <small>(std::map)</small>
			</>}
