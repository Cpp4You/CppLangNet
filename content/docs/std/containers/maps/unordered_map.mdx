...
tags:				[unordered_map, associative, container, key, unordered]
---
...
<SymbolTable noTraits>
	...
	<Symbol name="T" 		desc="The type of the stored values."/>
...
<SymbolTable>
	<Symbol pub autoLink linkName="empty" name="empty">
		Returns <code>true</code> if the unordered_map is empty, otherwise <code>false</code>.
	</Symbol>
...
<SymbolTable>
	<Symbol pub autoLink linkName="clear" name="clear">
		Clears the contents of a unordered_map.
	</Symbol>
	...
	<Symbol pub autoLink linkName="extract" name={<>extract <small>(since C++17)</small></>}>
		Extracts nodes from the unordered_map (can be later inserted somewhere else).
	</Symbol>
...
<SymbolTable>
	...
	<Symbol pub autoLink linkName="count" name="count">
		Returns the number of elements matching a specific key (for unordered_map it's always going to be 1 or 0).
	</Symbol>
	...
	<Symbol pub autoLink linkName="contains" name={<>contains <small>(since C++20)</small></>}>
		Returns <code>true</code> if an element is inside the unordered_map, otherwise <code>false</code>.
	</Symbol>
	<Symbol pub autoLink linkName="equal_range" name="equal_range">
		Returns a range of elements matching a specific key (for unordered_map it's always going to be one or zero elements).
	</Symbol>
</SymbolTable>
