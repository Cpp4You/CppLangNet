...
<details>
<summary>Technical definition of a unordered_multimap</summary>
<div>
...
<SymbolTable noTraits>
	<Symbol name={<>
			...
			desc="Compares the values in the unordered_multimap">
	</Symbol>
...
#### Creating unordered_multimap, inserting pair and printing it out
...
int main() {
  std::unordered_multimap<std::string, std::string> player_equipment
  	{ {"player2", "Sword"}, {"player2", "Health potion"} };
