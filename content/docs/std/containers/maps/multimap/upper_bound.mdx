...
# std::multimap upper_bound() method
...
Iterator pointing to the first element that is **greater** than `key`. If no such element is found, a past-the-end iterator (see [`end()`](/docs/std/containers/maps/multimap/end)) is returned.
