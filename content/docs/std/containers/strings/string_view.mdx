...
defined_in_headers:       "<string_view>"
...
import TemplateParameterTable from "./string_view/_codes/shared/template-parameter-table.mdx"
...
{/* Overview */}
import OverviewSimplifiedRegular from "./string_view/_codes/main-page/overview/overview-simplified-regular.mdx";
import OverviewDetailedRegular from "./string_view/_codes/main-page/overview/overview-detailed-regular.mdx";
...
All requirements on the iterator types of a [`Container`](/docs/named_req/Container) applies to the `iterator` and `const_iterator` types of [`std::basic_string_view`](#) as well.
:::
