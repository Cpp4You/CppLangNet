...
- **(2)** Modifying the past-the-end null terminator stored at `data() + size()` to any value other than `CharT()` has <Tooltip title={Term_UndefinedBehaviour}>undefined behavior</Tooltip>
:::
