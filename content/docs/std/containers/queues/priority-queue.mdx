...
It adapts a container by providing a new interface to it.
...
<SymbolTable noTraits>
	...
	<Symbol
			...
			desc={<>
				...
				By default <a href="/docs/containers/arays/vector"><code>std::vector&lt;T&gt;</code></a>.
				The container must satisfy <a href="/docs/named_req/SequenceContainer">SequenceContainer</a> and
				it's iterators must satisfy <a href="/docs/named_req/LegacyRandomAccessIterator">LegacyRandomAccessIterator</a>.
				</>}
		/>
	<Symbol
			name="Compare"
