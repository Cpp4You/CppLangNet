...
The new interface resembles a queue, a FIFO (First In First Out) data structure.
...
<SymbolTable>
	<Symbol pub autoLink name="push"
		...
		/>
	<Symbol pub autoLink name={<>emplace <small>(since C++11)</small></>}
	...
	<Symbol pub autoLink name="pop"
		...
		/>
	<Symbol pub autoLink name={<>swap <small>(since C++11)</small></>}
...
<SymbolTable>
	<Symbol prot name={<><code>Container</code> C</>}
			desc={<>The underlying container. By default <a href="/docs/containers/arrays/deque"><code>std::deque&lt;T&gt;</code></a>.</>}
		/>
</SymbolTable>
