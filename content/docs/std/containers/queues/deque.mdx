...
<SymbolTable>
	<Symbol pub autoLink linkName="constructors" name="(constructors)"
			desc="Constructs a deque."
		/>
	<Symbol pub autoLink linkName="destructor" name="(destructor)"
			desc="Destroys the deque, deallocating internal storage if used."
		/>
...
<SymbolTable noTraits>
	<Symbol name={<>
				...
				<Until v="cpp20">operator&lt;</Until> <br/>
				operator&gt; <small>(removed in C++20)</small><br/>
				operator&lt;= <small>(removed in C++20)</small><br/>
				operator&gt;= <small>(removed in C++20)</small><br/>
				operator&lt;=&gt;
			</>}
			desc="Lexicographically compares the values in the deque."
		/>
...
<SymbolTable noTraits>
	<Symbol name={<>
			<a href="#">std::uses_allocator</a> <small>(std::deque)</small>
		</>}
