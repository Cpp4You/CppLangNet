...
<details>
<summary>Technical definition of a unordered_set</summary>
<div>
...
<SymbolTable noTraits>
	...
	<Symbol name="Hash" 		desc="A unary callable, that takes an argument of type `Key`, and returns a unique value."/>
	<Symbol name="KeyEqual" 		desc="A binary, callable predicate that takes two arguments of type `Key` and returns a bool."/>
...
<SymbolTable>
	...
	<Symbol pub name="size_type"				desc="Unsigned integer type (usually std::size_t)"/>
	<Symbol pub name="difference_type"			desc="Signed integer type (usually std::ptrdiff_t)"/>
