---
title:					unordered_set<...>::equal_range() method
...
# std::unordered_set equal_range() method
...
If there are no such elements, past-the-end (see [`end()`](/docs/std/containers/sets/unordered_set/end)) iterators are returned as both elements of the pair.
