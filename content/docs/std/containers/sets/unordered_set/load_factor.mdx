...
Returns the average number of elements per bucket, that is, [`size()`](/docs/std/containers/sets/unordered_set/size) divided by [`bucket_count()`](/docs/std/containers/sets/unordered_set/bucket_count).
