...
### Complexity
 ...
 - **(3-4)**
   <SwitchView content={{
      'since-cpp11': <>
         Amortized constant if the insertion happens in the position <i>just before</i> the hint, logarithmic in the size of the container otherwise.
      </>,
      'until-cpp11': <>
         Amortized constant if the insertion happens in the position <i>just after</i> the hint, logarithmic in the size of the container otherwise.
      </>
    }} />
