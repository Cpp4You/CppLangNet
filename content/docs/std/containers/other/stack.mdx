...
<SymbolTable>
	<Symbol pub autoLink name="empty"
			desc={<>Returns <code>true</code> if the stack is empty, otherwise <code>false</code>.</>}
		/>
	<Symbol pub autoLink name="size" desc="Returns the number of elements in the stack." />
</SymbolTable>
...
<SymbolTable>
	...
	<Symbol pub autoLink name="pop"
			desc={<>Removes the first pushed element (the one that would've been returned by <code>stack.front()</code>).</>}
		/>
	<Symbol pub autoLink name={<>swap <small>(since C++11)</small></>} linkName="swap"
			desc="Swaps two stacks."
		/>
</SymbolTable>
...
<SymbolTable>
	<Symbol prot name={<><code>Container</code> C</>}
			desc={<>The underlying container. By default <a href="/docs/containers/stacks/deque"><code>std::deque&lt;T&gt;</code></a>.</>}
		/>
</SymbolTable>
...
<SymbolTable noTraits>
	<Symbol name={<>
			...
			desc="Lexicographically compares values in a stack."
		/>
...
<SymbolTable noTraits>
	<Symbol name={<>
			<a href="#">std::uses_allocator</a> <small>(std::stack)</small>
		</>}
