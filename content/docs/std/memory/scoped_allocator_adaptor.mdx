...
<ClassSummary name="scoped_allocator_adaptor" namespaces="std" folder="memory" headerName="memory"/>
...
<SymbolTable >
    <Symbol pub autoLink linkName="" name="(constructor)"                         desc="creates a new scoped_allocator_adaptor instance"/>
    <Symbol pub autoLink linkName="" name="(destructor)"                          desc="destructs a scoped_allocator_adaptor instance"/>
    <Symbol pub autoLink linkName="" name="operator="                             desc="assigns a scoped_allocator_adaptor"/>
    <Symbol pub autoLink linkName="" name="inner_allocator"                       desc="obtains an inner_allocator reference"/>
    <Symbol pub autoLink linkName="" name="outer_allocator"                       desc="obtains an outer_allocator reference"/>
    <Symbol pub autoLink linkName="" name="allocate"                              desc="allocates uninitialized storage using the outer allocator"/>
    <Symbol pub autoLink linkName="" name="deallocate"                            desc="deallocates storage using the outer allocator"/>
    <Symbol pub autoLink linkName="" name="max_size"                              desc="returns the largest allocation size supported by the outer allocator"/>
    <Symbol pub autoLink linkName="" name="construct"                             desc="constructs an object in allocated storage, passing the inner allocator to its constructor if appropriate"/>
    <Symbol pub autoLink linkName="" name="destroy"                               desc="destructs an object in allocated storage"/>
    <Symbol pub autoLink linkName="" name="select_on_container_copy_construction" desc="copies the state of scoped_allocator_adaptor and all its allocators"/>
</SymbolTable>

### Non-member functions

<SymbolTable noTraits>
    <Symbol name={<Removed v='cpp20'>operator==<br/>operator!=</Removed>} desc={<>compares two scoped_allocator_adaptor instances</>}/>
</SymbolTable>
