...
<SymbolTable noTraits>
    <Symbol autoLink linkName="/docs/std/memory/_shared_ptr/unique_ptr" name="(constructors)"              
    desc={<>
                constructs new shared_ptr<br/>
                <small>(public member function)</small>
                </>} 
                />
    <Symbol autoLink linkName="/docs/std/memory/_shared_ptr/~unique_ptr" name="(destructor)"
    desc={<>
