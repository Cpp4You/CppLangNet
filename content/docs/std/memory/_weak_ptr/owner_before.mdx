...
Checks whether this weak_ptr precedes other in implementation defined owner-based (as opposed to value-based) order. 
...
`other`	-	the [std::shared_ptr](../shared_ptr) or [std::weak_ptr](../weak_ptr) to be compared
...
| LWG 2942 | C++11      | weak_ptr::owner_before is missed in LWG 2873's resolution | made noexcept     |
