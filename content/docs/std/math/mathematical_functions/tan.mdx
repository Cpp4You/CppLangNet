...
Computes the tangent of `num` (measured in radians). The library provides overloads of `std::tan` for all cv-unqualified floating-point types as the type of the parameter num. <Since v='cpp23'></Since>
