...
Computes the hyperbolic tangent of <code>num</code>. The library provides overloads of `std::tanh` for all cv-unqualified floating-point types as the type of the parameter <code>num</code> <Since v='cpp23'></Since>.
