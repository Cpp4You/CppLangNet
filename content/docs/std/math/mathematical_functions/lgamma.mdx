...
Computes the natural logarithm of the absolute value of the gamma function of <code>num</code>.
 The library provides overloads of `std::lgamma` for all cv-unqualified floating-point types as the type of the parameter <code>num</code> <Since v='cpp23'></Since>.<br/>
