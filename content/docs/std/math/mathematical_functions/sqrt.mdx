...
Computes the square root of <code>num</code>. The library provides overloads of `std::sqrt` for all cv-unqualified floating-point types as the type of the parameter <code>num</code>. <Since v='cpp23'></Since>
