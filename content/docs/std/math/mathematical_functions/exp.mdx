...
### Description
 ...
 raised to the given power <code>num</code>. The library provides overloads of `std::exp` for all cv-unqualified floating-point types as the type of the parameter num.
