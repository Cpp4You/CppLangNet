...
`std::isunordered(num1, num2)` has the same effect as  <br/>
&#8203;<code>std::isunordered(<a href='/docs/std/lang-support/static_cast'>static_cast</a>&lt;<span class='col-lb'>float</span>&gt;(num1), <a href='/docs/std/lang-support/static_cast'>static_cast</a>&lt;<span class='col-lb'>float</span>&gt;(num2))</code>.
(until C++23)
