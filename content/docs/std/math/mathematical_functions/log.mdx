...
Computes the natural (base `e`) logarithm of <code>num</code>. The library provides overloads of `std::log` for all cv-unqualified floating-point types as the type of the parameter <code>num</code>.
