...
### Description
Computes the hyperbolic cosine of `num`. The library provides overloads of `std::cosh` for all cv-unqualified floating-point types as the type of the parameter `num`. <Since v='cpp23'></Since>
