...
Computes the hyperbolic sine of `num`. The library provides overloads of `std::sinh` for all cv-unqualified floating-point types as the type of the parameter `num`. <Since v='cpp23'></Since>
