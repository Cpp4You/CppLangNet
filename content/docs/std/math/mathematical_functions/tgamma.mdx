...
### Description
Computes the gamma function of `num`. The library provides overloads of `std::tgamma` for all cv-unqualified floating-point types as the type of the parameter `num` <Since v='cpp23'></Since>.
