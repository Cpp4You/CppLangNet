...
- **(2)** Same as **(1)**, but executed according to `policy`.
	...
	<Until v='cpp20'> std::is_execution_policy_v&lt;std::decay_t&lt;ExecutionPolicy&gt;&gt; </Until> <Since v='cpp20'>std::is_execution_policy_v&lt;std::remove_copy_cvref_t&lt;ExecutionPolicy&gt;&gt;</Since> is <code>true</code>.
	:::
