...
- `BidirIt` must meet the requirements of [`ValueSwappable`](/docs/named_req/ValueSwappable) and [`LegacyBidirectionalIterator`](/docs/named_req/LegacyBidirectionalIterator).
