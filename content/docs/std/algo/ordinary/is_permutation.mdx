...
import Signature_SinceCpp17 from './_codes/is_permutation/since-cpp17.mdx';
...
The <Tooltip term={ <Term_UndefinedBehaviour /> }>behavior is undefined</Tooltip> if it is not an equivalence relation.
:::
