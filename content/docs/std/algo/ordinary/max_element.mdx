---
title:         max_element algorithm
sidebar_label: max_element(  )
description:   max_element algorithm C++ documentation
hide_title:    true
tags:          [algorithm, max_element, max, biggest, largest, greatest]

cppreference_origin_rel: w/cpp/algorithm/max_element
---
...
import Signature_UntilCpp17 from './_codes/max_element/until-cpp17.mdx';
import Signature_SinceCpp17 from './_codes/max_element/since-cpp17.mdx';
