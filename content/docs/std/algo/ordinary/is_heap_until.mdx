---
title:         is_heap_until algorithm
sidebar_label: is_heap_until(  )
description:   is_heap_until algorithm C++ documentation
hide_title:    true
tags:          [algorithm, is_heap_until, find_if, find, search, look, predicate, condition]

cppreference_origin_rel: w/cpp/algorithm/is_heap_until
---
...
import Signature_SinceCpp11 from './_codes/is_heap_until/since-cpp11.mdx';
import Signature_SinceCpp17 from './_codes/is_heap_until/since-cpp17.mdx';
import Signature_SinceCpp20 from './_codes/is_heap_until/since-cpp20.mdx';
...
Examines the range [`first`; `last`) and finds the largest range beginning at `first` which is a [**max heap**](https://en.wikipedia.org/wiki/Binary_heap).
