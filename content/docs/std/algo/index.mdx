...
<SymbolTable>
	...
	<SwitchView content={{
		...
		'Ordinary':
			<Symbol pub autoLink linkName="./ordinary/all_of" name="all_of">
				Checks if all elements in a range hold a condition.
			</Symbol>,
	}}/>
	...
	<SwitchView content={{
		...
		'Ordinary':
			<Symbol pub autoLink linkName="./ordinary/any_of" name="any_of">
				Checks if any elements in a range hold a condition.
			</Symbol>,
	}}/>
	...
	<SwitchView content={{
		...
		'Ordinary':
			<Symbol pub autoLink linkName="./ordinary/none_of" name="none_of">
				Checks if no elements in a range hold a condition.
			</Symbol>,
	}}/>
