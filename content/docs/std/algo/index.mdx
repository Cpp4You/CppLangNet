...
<SymbolTable>
	...
	<SwitchView content={{
		'Rangified':
			<Symbol pub autoLink linkName="./algo/ranges/count" name={ <Since v='cpp20'>ranges::count</Since> }>
				Returns the number of certain elements.
			</Symbol>,
		'Ordinary':
			<Symbol pub autoLink linkName="./algo/ordinary/count" name="count">
				Returns the number of certain elements.
			</Symbol>,
	}}/>
	...
	<SwitchView content={{
		'Rangified':
			<Symbol pub autoLink linkName="./algo/ranges/count_if" name={ <Since v='cpp20'>ranges::count_if</Since> }>
				Returns the number of elements satisfying specific criteria.
			</Symbol>,
		'Ordinary':
			<Symbol pub autoLink name="./algo/ordinary/count_if">
				Returns the number of elements satisfying specific criteria.
			</Symbol>,
	}}/>
...
<SymbolTable>
	...
	<SwitchView content={{
		'Rangified':
			<Symbol pub autoLink linkName="./algo/ranges/transform" name={ <Since v='cpp20'>ranges::transform</Since> }>
				Applies a function to a range of elements.
			</Symbol>,
		'Ordinary':
			<Symbol pub autoLink name="./algo/ordinary/transform">
				Applies a function to a range of elements.
			</Symbol>,
	}}/>
	...
	<SwitchView content={{
		...
		'Ordinary':
			<Symbol pub autoLink name="./ordinary/reverse">
				Reverses the order of elements.
			</Symbol>,
	}}/>
...
<SymbolTable>
	...
	<SwitchView content={{
		'Rangified':
			<Symbol pub autoLink linkName="./algo/ranges/min" name={ <Since v='cpp20'>ranges::min</Since> }>
				Returns the smallest of the given values.
			</Symbol>,
		'Ordinary':
			<Symbol pub autoLink name="./algo/ordinary/min">
				Returns the smallest of the given values.
			</Symbol>,
	}}/>
	...
	<SwitchView content={{
		'Rangified':
			<Symbol pub autoLink linkName="./algo/ranges/max" name={ <Since v='cpp20'>ranges::max</Since> }>
				Returns the greatest of the given values.
			</Symbol>,
		'Ordinary':
			<Symbol pub autoLink name="./algo/ordinary/max">
				Returns the greatest of the given values.
			</Symbol>
	}}/>
