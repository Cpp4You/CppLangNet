...
<SymbolTable>
	...
	<SwitchView content={{
		...
		'Ordinary':
			<Symbol pub autoLink name="count">
				Returns the number of certain elements.
			</Symbol>,
	}}/>
	...
	<SwitchView content={{
		...
		'Ordinary':
			<Symbol pub autoLink name="count_if">
			Returns the number of elements satisfying specific criteria.
			</Symbol>,
	}}/>
...
<SymbolTable>
	...
	<SwitchView content={{
		...
		'Ordinary':
			<Symbol pub autoLink name="transform">
				Applies a function to a range of elements.
			</Symbol>,
	}}/>
