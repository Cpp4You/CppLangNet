...
<SymbolTable>
	...
	<SwitchView content={{
		...
		'Ordinary':
			<Symbol pub autoLink name="./ordinary/count_if">
				Returns the number of elements satisfying specific criteria.
			</Symbol>,
	}}/>
...
<SymbolTable>
	...
	<SwitchView content={{
		...
		'Ordinary':
			<Symbol pub autoLink name="./ordinary/transform">
				Applies a function to a range of elements.
			</Symbol>,
	}}/>
...
<SymbolTable>
	...
	<SwitchView content={{
		...
		'Ordinary':
			<Symbol pub autoLink name="./ordinary/min">
				Returns the smallest of the given values.
			</Symbol>,
	}}/>
	...
	<SwitchView content={{
		...
		'Ordinary':
			<Symbol pub autoLink name="./ordinary/max">
				Returns the greatest of the given values.
			</Symbol>
	}}/>
