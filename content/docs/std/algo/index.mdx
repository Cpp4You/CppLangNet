...
<SymbolTable>
	...
	<SwitchView content={{
		...
		'Ordinary':
			<Symbol pub autoLink linkName="./ordinary/find" name="find">
				Finds the first element satisfying specific criteria.
			</Symbol>,
	}}/>
	...
	<SwitchView content={{
		'Rangified':
			<Symbol pub autoLink linkName="./ranges/find_if" name={ <Since v='cpp20'>ranges::find_if</Since> }>
				Finds the first element satisfying specific predicate.
			</Symbol>,
		'Ordinary':
			<Symbol pub autoLink linkName="./ordinary/find_if" name="find_if">
				Finds the first element satisfying specific predicate.
			</Symbol>,
	}}/>
	...
	<SwitchView content={{
		'Rangified':
			<Symbol pub autoLink linkName="./ranges/find_if_not" name={ <Since v='cpp20'>ranges::find_if_not</Since> }>
				Finds the first element **not** satisfying specific predicate.
			</Symbol>,
		'Ordinary':
			<Symbol pub autoLink linkName="./ordinary/find_if_not" name={ <Since v='cpp11'>find_if_not</Since> }>
				Finds the first element **not** satisfying specific predicate.
			</Symbol>,
	}}/>
	...
	<SwitchView content={{
		'Rangified':
			<Symbol pub autoLink linkName="./ranges/find_end" name={ <Since v='cpp20'>ranges::find_end</Since> }>
        Finds the last sequence of elements in a certain range.
			</Symbol>,
		'Ordinary':
			<Symbol pub autoLink linkName="./ordinary/find_end" name="find_end">
        Finds the last sequence of elements in a certain range.
			</Symbol>,
	}}/>
	...
	<SwitchView content={{
		'Rangified':
			<Symbol pub autoLink linkName="./ranges/find_last" name={ <Since v='cpp20'>ranges::find_last</Since> }>
  ...
  <SwitchView content={{
    'Rangified':
      <Symbol pub autoLink linkName="./ranges/find_last_if" name={ <Since v='cpp20'>ranges::find_last_if</Since> }>
  ...
  <SwitchView content={{
    'Rangified':
      <Symbol pub autoLink linkName="./ranges/find_last_if_not" name={ <Since v='cpp20'>ranges::find_last_if_not</Since> }>
  ...
  <SwitchView content={{
    'Rangified':
      <Symbol pub autoLink linkName="./ranges/adjacent_find" name={ <Since v='cpp20'>ranges::adjacent_find</Since> }>
        Finds the first two adjacent items that satisfy a condition.
      </Symbol>,
    'Ordinary':
      <Symbol pub autoLink linkName="./ordinary/adjacent_find" name="adjacent_find">
        Finds the first two adjacent items that satisfy a condition.
      </Symbol>,
  }}/>
	...
	<SwitchView content={{
		'Rangified':
			<Symbol pub autoLink linkName="./ranges/search" name={ <Since v='cpp20'>ranges::search</Since> }>
        Search for a range of elements.
			</Symbol>,
		'Ordinary':
			<Symbol pub autoLink linkName="./ordinary/search" name="search">
        Search for a range of elements.
			</Symbol>,
	}}/>
	...
	<SwitchView content={{
		'Rangified':
			<Symbol pub autoLink linkName="./ranges/search_n" name={ <Since v='cpp20'>ranges::search_n</Since> }>
        Searches a range for a consecutive sequence of an element.
			</Symbol>,
		'Ordinary':
			<Symbol pub autoLink linkName="./ordinary/search_n" name="search_n">
        Searches a range for a consecutive sequence of an element.
			</Symbol>,
	}}/>
...
<SymbolTable>
	...
	<SwitchView content={{
		'Rangified':
			<Symbol pub autoLink linkName="./ranges/mismatch" name={ <Since v='cpp20'>ranges::mismatch</Since> }>
        Finds the first position where two ranges differ.
			</Symbol>,
		'Ordinary':
			<Symbol pub autoLink linkName="./ordinary/mismatch" name="mismatch">
				Finds the first position where two ranges differ.
			</Symbol>,
	}}/>
  ...
  <SwitchView content={{
    'Rangified':
      <Symbol pub autoLink linkName="./ranges/starts_with" name={ <Since v='cpp20'>ranges::starts_with</Since> }>
  ...
  <SwitchView content={{
    'Rangified':
      <Symbol pub autoLink linkName="./ranges/ends_with" name={ <Since v='cpp20'>ranges::ends_with</Since> }>
