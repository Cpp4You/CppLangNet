...
hide_title:    true
tags:          [ranges, algorithm, remove_copy_if, search, look]

cppreference_origin_rel: w/cpp/algorithm/ranges/remove_copy_if
---
...
<SymbolTable>
  ...
  <Symbol none noLink name={ <code>pred</code> }>
    Unary predicate which returns `true` if the element should be <b>ignored</b>.
  </Symbol>
