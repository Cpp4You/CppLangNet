...
hide_title:    true
tags:          [ranges, algorithm, rotate_copy, replace]
...
:::danger Undefined Behaviour
 The <Tooltip term={ <Term_UndefinedBehaviour/> }>behavior is undefined</Tooltip> if either [`first`; `middle`) or [`middle`; `last`) is not a valid range, or the source and destination ranges overlap.
:::
