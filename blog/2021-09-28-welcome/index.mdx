...
![Docusaurus Plushie](./rocket-launch-banner.jpg)
...
- [tutorials](./learn/index) that are as easy to understand for beginners as it is possible
but teach a modern and proper way to use C++.
- [documentation](./docs/index) with examples that is easy to read but contain most recent
and correct information about C++ language, its standard library and possibly other libraries too
- [tools](./tools/index) knowledge base with tutorials
- [features](./features/index) summary of the C++ language, that enables programmers to know the latest
language updates
...
consider creating a [pull request](https://github.com/PoetaKodu/CppLangNet/pulls) with your work.
...
Please read our [Contributing Guide](https://github.com/PoetaKodu/CppLangNet/main/CONTRIBUTING.md)
