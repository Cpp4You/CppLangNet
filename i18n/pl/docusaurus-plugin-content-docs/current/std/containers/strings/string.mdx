...
<details>
	...
	<div>
		<Class.SymbolTable noTraits>
			<Class.Symbol name="std::string"			desc={<code>std::basic_string&lt;char&gt;</code>}/>
			<Class.Symbol name="std::wstring" 			desc={<code>std::basic_string&lt;wchar_t&gt;</code>}/>
			<Class.Symbol name="std::u8string"			desc={<code>std::basic_string&lt;char8_t&gt;</code>}/>
			<Class.Symbol name="std::u16string"			desc={<code>std::basic_string&lt;char16_t&gt;</code>}/>
			<Class.Symbol name="std::u32string"			desc={<code>std::basic_string&lt;char32_t&gt;</code>}/>
			<Class.Symbol name="std::pmr::string"		desc={<code>std::pmr::basic_string&lt;char&gt;</code>}/>
			<Class.Symbol name="std::pmr::wstring" 		desc={<code>std::pmr::basic_string&lt;wchar_t&gt;</code>}/>
			<Class.Symbol name="std::pmr::u8string"		desc={<code>std::pmr::basic_string&lt;char8_t&gt;</code>}/>
			<Class.Symbol name="std::pmr::u16string"	desc={<code>std::pmr::basic_string&lt;char16_t&gt;</code>}/>
			<Class.Symbol name="std::pmr::u32string"	desc={<code>std::pmr::basic_string&lt;char32_t&gt;</code>}/>
		</Class.SymbolTable>
	</div>
</details>
...
<Class.SymbolTable noTraits>
	<Class.Symbol name="CharT"		desc="character type"/>
	<Class.Symbol name="Traits" 	desc="traits class specifying the operations on the character type"/>
	<Class.Symbol name="Allocator"	desc={<><a href="/docs/named_req/allocator">Allocator</a> type used to allocate internal storage</>}/>
</Class.SymbolTable>

## Type names

<Class.SymbolTable>
	<Class.Symbol pub name="traits_type"			desc={<code>Traits</code>}/>
	<Class.Symbol pub name="value_type" 			desc={<code>CharT</code>}/>
	<Class.Symbol pub name="allocator_type"			desc={<code>Allocator</code>}/>
	<Class.Symbol pub name="size_type"				desc={<code>std::allocator_traits&lt;Allocator&gt;::size_type</code>}/>
	<Class.Symbol pub name="difference_type"		desc={<code>std::allocator_traits&lt;Allocator&gt;::difference_type</code>}/>
	<Class.Symbol pub name="reference"				desc={<code>value_type</code>}/>
	<Class.Symbol pub name="const_reference"		desc={<code>value_type const&amp;</code>}/>
	<Class.Symbol pub name="pointer"				desc={<code>std::allocator_traits&lt;Allocator&gt;::pointer</code>}/>
	<Class.Symbol pub name="const_pointer"			desc={<code>std::allocator_traits&lt;Allocator&gt;::const_pointer</code>}/>
	<Class.Symbol pub name="iterator"				desc={<><a href="#"><code>LegacyRandomAccessIterator</code></a> to <code>value_type</code></>}/>
	<Class.Symbol pub name="const_iterator"			desc={<><a href="#"><code>LegacyRandomAccessIterator</code></a> to <code>value_type const</code></>}/>
	<Class.Symbol pub name="reverse_iterator"		desc={<><a href="#"><code>std::reverse_iterator&lt;iterator&gt;</code></a></>}/>
	<Class.Symbol pub name="const_reverse_iterator"	desc={<><a href="#"><code>std::reverse_iterator&lt;const_iterator&gt;</code></a></>}/>
</Class.SymbolTable>

## Member functions

<Class.SymbolTable>	
	<Class.Symbol pub autoLink linkName="constructor" name="(constructor)">
		Constructs a <code>basic_string</code>
	</Class.Symbol>
	<Class.Symbol pub autoLink linkName="destructor" name="(destructor)">
		Destroys the string, deallocating internal storage if used
	</Class.Symbol>
	<Class.Symbol pub autoLink linkName="operator_assign" name="operator="
			desc="Assigns values to the string"
		/>
	<Class.Symbol pub autoLink name="assign"
			desc="Assigns characters to the string"
		/>
	<Class.Symbol pub autoLink name="get_allocator"
...
<Class.SymbolTable>	
	<Class.Symbol pub autoLink name="at"
			desc={<>Accesses the specified character <b>with bounds checking</b></>}
		/>
	<Class.Symbol pub autoLink linkName="operator_index" name="operator[]"
			desc={<>Accesses the specified character</>}
		/>
	<Class.Symbol pub autoLink name="front"
			desc="Returns the first character"
		/>
	<Class.Symbol pub autoLink name="back"
			desc="Returns the last character"
		/>
	<Class.Symbol pub autoLink name="data"
			desc="Returns a pointer to the first character of a string"
		/>
	<Class.Symbol pub autoLink name="c_str"
			desc="Returns a non-modifiable standard C character array version of the string"
		/>
	<Class.Symbol pub autoLink linkName="operator_basic_string_view" name="operator basic_string_view"
...
<Class.SymbolTable>	
	<Class.Symbol pub autoLink linkName="begin" name={<>begin<br/>cbegin</>}
			desc={<>Returns an <code>iterator/const_iterator</code> to the beginning</>}
		/>
	<Class.Symbol pub autoLink linkName="end" name={<>end<br/>cend</>}
			desc={<>Returns an <code>iterator/const_iterator</code> to the end</>}
		/>
	<Class.Symbol pub autoLink linkName="rbegin" name={<>rbegin<br/>crbegin</>}
			desc={<>Returns an reverse <code>iterator/const_iterator</code> to the beginning</>}
		/>
	<Class.Symbol pub autoLink linkName="rend" name={<>rend<br/>crend</>}
...
<Class.SymbolTable>
	<Class.Symbol pub autoLink name="clear"
			desc="Clears the contents"
		/>
	<Class.Symbol pub autoLink name="insert"
			desc="Inserts characters"
		/>
	<Class.Symbol pub autoLink name="erase"
			desc="Removes characters"
		/>
	<Class.Symbol pub autoLink name="push_back"
			desc="Appends a character to the end"
		/>
	<Class.Symbol pub autoLink name="pop_back"
			desc="Removes the last character"
		/>
	<Class.Symbol pub autoLink name="append"
			desc="Appends characters to the end"
		/>
	<Class.Symbol pub autoLink linkName="operator_addeq" name="operator+="
			desc="Appends characters to the end"
		/>
	<Class.Symbol pub autoLink name="compare"
			desc="Compares two strings"
		/>
	<Class.Symbol pub autoLink name="starts_with"
			desc="Checks if the string starts with the given prefix"
		/>
	<Class.Symbol pub autoLink name="ends_with"
			desc="Checks if the string ends with the given suffix"
		/>
	<Class.Symbol pub autoLink name="contains"
			desc="Checks if the string contains the given substring or character"
		/>
	<Class.Symbol pub autoLink name="replace"
			desc="Replaces specified portion of a string"
		/>
	<Class.Symbol pub autoLink name="substr"
			desc="Returns a substring"
		/>
	<Class.Symbol pub autoLink name="copy"
			desc="Copies characters"
		/>
	<Class.Symbol pub autoLink name="resize"
			desc="Changes the number of characters stored"
		/>
	<Class.Symbol pub autoLink name="swap"
...
<Class.SymbolTable>
	<Class.Symbol pub autoLink name="find"
			desc="Find characters in the string"
		/>
	<Class.Symbol pub autoLink name="rfind"
			desc="Find the last occurrence of a substring"
		/>
	<Class.Symbol pub autoLink name="find_first_of"
			desc="Find first occurrence of characters"
		/>
	<Class.Symbol pub autoLink name="find_first_not_of"
			desc="Find first absence of characters"
		/>
	<Class.Symbol pub autoLink name="find_last_of"
			desc="Find last occurrence of characters"
		/>
	<Class.Symbol pub autoLink name="find_last_not_of"
...
<Class.SymbolTable noTraits>
	...
	<Class.Symbol name={<>
		...
		/>
	<Class.Symbol name={<>std::swap <small>(std::basic_string)</small></>}
