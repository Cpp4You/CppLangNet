...
Podgląd:<br/>
![Instalator MSYS2 - ścieżka](https://www.msys2.org/images/install-2-path.png)
...
Podgląd:<br/>
![Uruchamianie konsoli MSYS2](/img/tutorials/tools/msys2/run-msys2-pl.png)
...
Podgląd:<br/>
![Wybieranie pakietów MinGW64](/img/tutorials/tools/msys2/mingw-packages.png)
