...
<Image center
		...
		src="/img/tutorials/course/intermediate/lambdas/capture-list-pl.png"
		desc={<></>}
	/>
<br/>
...
<Columns spacing={40} columns={['5.5fr', '5.5fr']}>
<div>
...
```
#### Co chcemy zrobić?
W naszym przykładzie stworzymy wektor liczb całkowitych (`int`) oraz lambdę, która podnosi liczby do kwadratu. Użyjemy do tego algorytmu `transform()` z biblioteki standardowej. Wyślemy mu nasz wektor, lambdę oraz wektor, do którego algorytm zapisze wyniki. 
