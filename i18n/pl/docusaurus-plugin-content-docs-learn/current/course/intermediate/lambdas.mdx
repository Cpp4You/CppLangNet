...
:::important *"Nienazwane funkcje, obiekty funkcyjne"*
Lambdy często nazywane są **nienazwanymi funkcjami** (*ang. anonymous function*) lub **obiektami funkcyjnymi** (*ang. function object*).
