...
```
Lambda musi posiadać ciało i listę wychwytywania (może być pusta). Często spotyka się też listę argumentów. Reszta rzeczy (jak atrybuty, typ rezultatu itp.) nie są obowiązkowe, więc porozmawiamy o nich w lekcji drugiej.
...
Zmiennych wychwyconych nie można edytować. Jest sposób na obejście tego ograniczenia, jednak porozmawiamy o tym w lekcji drugiej.
:::
