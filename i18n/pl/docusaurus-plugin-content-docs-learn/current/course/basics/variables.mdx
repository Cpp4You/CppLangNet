...
Przykłady tworzenia zmiennych wyżej wymienionych typów:
...
Zwróć uwagę na operator **inkrementacji** i **dekrementacji**:

```cpp
value++; // inkrementacja czyli zwiększ o 1
value--; // dekrementacja czyli zmniejsz o 1
```