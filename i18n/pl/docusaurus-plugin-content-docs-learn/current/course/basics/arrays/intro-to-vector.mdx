...
Indeksy pozwalają rozróżnić elementy tablicy. Za ich pomocą
możemy korzystać z nich w kodzie.
...
- po nazwie tablicy dajemy kropkę
- piszemy nazwę *metody*, czyli w tym wypadku `push_back`
- następnie w nawiasie okrągłym podajemy co chcemy dodać (np. wartość lub zmienną)
...
:::tip Dedukcja typu
**Jeśli można łatwo się domyśleć** jakiego typu elementy przechowuje tablica,
