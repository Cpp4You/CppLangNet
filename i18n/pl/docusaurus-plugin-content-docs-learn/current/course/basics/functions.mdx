...
```
Bardzo możliwe, że dostaniemy ostrzeżenie o braku zwróconej wartości, ale kod ten powinien się skompilować się.
Kiedy będziemy jednak próbowali uruchomić nasz program, możemy się zaskoczyć:
...
Jej zadaniem jest upewnienie się, że dana wartość nie przekracza przedziału z żadnej stron.
...
Drugim powód jest taki, że implementacja funkcji może się zmienić na przestrzeni rozwoju naszej aplikacji.
