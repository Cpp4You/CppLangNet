...
O samym `#include` powiemy sobie w przyszłości więcej - na teraz wystarczy.
...
:::caution Backslash
Zwróć uwagę, że używany jest **backslash** (`\n`), a nie slash (`/n`)
:::
...
Zapis `\n` umieszczony w kodzie, wewnątrz tekstu jest tak naprawdę **pojedynczym znakiem** dla programu.
...
Można go pominąć, jeśli użyjemy wcześniej odpowiedniej linijki kodu:
...
<Image center
		alt="Ilustracja błędu - brak cudzysłowu"
		src="/img/tutorials/course/basic/first-program/error-no-terminating-quote-pl.png"
	/>