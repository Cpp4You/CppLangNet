...
Poniżej znajdują się przykłady tego jak wygląda program "Witaj świecie" w konsoli. Nie każdy terminal jest taki sam, ale każdy wygląda bardzo
podobnie - po prostu wyświetla tekst w jednym konkretnym kolorze.
...
:::info TODO
Dodać link do poradnika jak wykonywać podstawowe operacje w konsoli.
:::
