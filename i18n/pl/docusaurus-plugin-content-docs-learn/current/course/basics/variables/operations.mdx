...
W tej lekcji nauczymy się wykonywania różnych operacji z użyciem zmiennych, będziemy:
- zapisywać do nich wartości,
- modyfikować z użyciem wyrażeń matematycznych,
- wyświetlać ich zawartość w konsoli.

Dowiemy się też jak pozwolić na prostą interakcję z użytkownikiem programu.
