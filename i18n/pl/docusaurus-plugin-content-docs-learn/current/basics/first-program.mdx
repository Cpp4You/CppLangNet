...
Który wyświetla tekst podany powyżej w okienku "Wynik".
...
Tak jak wspominaliśmy we <a href="./programming-intro">wstępie</a>, komputer wykonuje program linijka po linijce.
...
Średnik (`;`) oddziela od siebie instrukcję. Kompilator nie patrzy czy instrukcje są napisane w osobnych liniach.
